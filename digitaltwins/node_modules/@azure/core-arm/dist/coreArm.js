...
(function (global, factory) {
    ...
    (global = global || self, factory((global.Azure = global.Azure || {}, global.Azure.Core = global.Azure.Core || {}, global.Azure.Core.ARM = {}), global.Azure.Core.HTTP));
    ...
    ***************************************************************************** */
    ...
    var LROPollStrategy = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, coreHttp.delay(delayInSeconds * 1000)];
                        case 1:
                            _a.sent();
        ...
        LROPollStrategy.prototype.getRestError = function () {
            var error = new coreHttp.RestError("");
            error.request = coreHttp.stripRequest(this._pollState.mostRecentRequest);
            ...
            if (error.response.parsedBody) {
                var innerError = error.response.parsedBody.error;
                if (innerError) {
        ...
        LROPollStrategy.prototype.updateOperationStatus = function (statusUrl, shouldDeserialize) {
            ...
            var httpRequest = new coreHttp.WebResource(requestUrl, "GET");
    ...
    function getResponseBody(response) {
        ...
        try {
            ...
            var deserializationError = new coreHttp.RestError("Error \"" + error + "\" occurred in parsing the responseBody \" +\n      \"while creating the PollingState for Long Running Operation- \"" + response.bodyAsText + "\"");
        ...
        LocationLROPollStrategy.prototype.sendPollRequest = function () {
            ...
            return this.updateOperationStatus(lroPollState.locationHeaderValue, this.locationStrategyShouldDeserialize.bind(this)).then(function (result) {
                ...
                if (statusCode === 202) {
                    ...
                    throw new coreHttp.RestError(errorMessage, undefined, statusCode, coreHttp.stripRequest(result.request), result);
                }
                else {
        ...
        AzureAsyncOperationLROPollStrategy.prototype.sendPollRequest = function () {
            ...
            return this.updateOperationStatus(lroPollState.azureAsyncOperationHeaderValue, false).then(function (response) {
                ...
                if (statusCode !== 200 && statusCode !== 201 && statusCode !== 202 && statusCode !== 204) {
                    var error = new coreHttp.RestError("Invalid status code (" + statusCode + ") with response body \"" + response.bodyAsText + "\" occurred when polling for operation status.");
                    error.statusCode = statusCode;
                    error.request = coreHttp.stripRequest(response.request);
    ...
    var GetResourceLROPollStrategy = /** @class */ (function (_super) {
        ...
        GetResourceLROPollStrategy.prototype.sendPollRequest = function () {
            ...
            return this.updateOperationStatus(lroPollState.initialResponse.request.url, false).then(function (result) {
                ...
                if (statusCode !== 200 && statusCode !== 201 && statusCode !== 202 && statusCode !== 204) {
                    var error = new coreHttp.RestError("Invalid status code with response body \"" + result.bodyAsText + "\" occurred when polling for operation status.");
                    error.statusCode = statusCode;
                    error.request = coreHttp.stripRequest(result.request);
    ...
    function flattenAzureResponse(response) {
        ...
        return coreHttp.flattenResponse(response, operationResponseGetter && operationSpec && operationResponseGetter(operationSpec, response));
    }
    ...
    exports.coreArmVersion = coreArmVersion;
...
//# sourceMappingURL=coreArm.js.map
